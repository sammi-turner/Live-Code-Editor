...
<section class="card" style="max-width:52rem;margin:2.4rem auto;padding:1.8rem;text-align:center">
  <h1>This example runs locally in the browser.</h1>
  <button id="btn">Try me</button>
</section>`, -1);

  ed_css.setValue(`body{font-family:system-ui;background:#f7fafc;margin:0}
h1{color:#0f172a}
#btn{padding:.75rem 1rem;border:0;border-radius:1rem;background:#60a5fa;color:#08111f;font-weight:700}`, -1);
